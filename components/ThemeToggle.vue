...
<template>
  <div class="ml-4 text-2xl cursor-pointer items-center relative group" @click="toggleTheme">
    ...
    <div role="tooltip" class="absolute top-7 right-0 whitespace-nowrap card rounded-lg p-2 text-sm color-action hidden group-hover:block">
